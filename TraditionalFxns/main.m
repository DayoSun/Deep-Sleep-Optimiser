...
Benchmark = {'benchmark_1000dim.csv'}; % Change the dim to reflect the problem's dim i.e 1000 to something else
Compute = {'Compute_1000dim.csv'}; % Change the dim to reflect the problem's dim i.e 1000
Rank = {'Rank_1000dim.csv'};  % Change the dim to reflect the problem's dim i.e 1000
Fnn = 1:23; Fnn=Fnn';
%% Parameters
nPop=20;                    % Number of search agents
MaxItr=5;                 % Maximum numbef of iterations
run=2;                     % Independent run
dim=6;                   % dimension of problem
...
for h = 1:length(dim)
    ...
    % Chose an appropriate destination on your PC
    FolderName = 'C:\Users\dayo\Desktop\Deep Sleep optimization work\DSO_version_latest_CODES\Figures';
